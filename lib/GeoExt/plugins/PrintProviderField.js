...
GeoExt.plugins.PrintProviderField = Ext.extend(Ext.util.Observable, {
    ...
    onRender: function(field) {
        ...
        } else if(field.store === printProvider.formats) {
            field.setValue(printProvider.format.get(field.displayField));
            printProvider.on({
                "formatchange": this.onProviderChange,
                scope: this
            });
        ...
        if(record) {
            switch(field.store) {
                ...
                case printProvider.dpis:
                    ...
                    break;
                case printProvider.formats:
                    printProvider.setFormat(record);
            }
        } else {
     ...
     *  
     *  Handler for the printProvider's dpichange, formatchange and layoutchange event
     */
    ...
    onBeforeDestroy: function() {
        ...
        printProvider.un("formatchange", this.onProviderChange, this);
    }

...
GeoExt.data.PrintPage = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function(config) {
		...
		// use this instead of WKT - WKT returns undefined
        this.feature = new OpenLayers.Feature.Vector(
            this.feature = new OpenLayers.Geometry.Polygon([new OpenLayers.Geometry.LinearRing(new OpenLayers.Geometry.Point(-1, -1),
